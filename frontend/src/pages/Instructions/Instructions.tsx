    ...
    <ContentWrapper>
      ...
      <div>
        <div className="mt-4">
          ...
          <img alt="Initial game board setup" className="mt-2" src={initialSetupImage} />
        </div>
        <div className="mt-4">
          <h2>
            Moving Your Pieces
          ...
          <img alt="example moves for a piece" className="mt-2" src={standardPieceMoves} />
        </div>
        <div className="mt-4">
          ...
          <img alt="demonstration of piece movement rules for standard pieces" className="mt-2" src={turn}/>
          ...
          <img alt="demonstration of piece movement rules for power pieces" className="mt-2" src={powerPieceMoves} />
        </div>
        <div className="mt-4">
          <h2>Goal Area</h2>
          <p className="lead">The objective is to move all nine pieces into the goal.</p>
          <img alt="board with pieces in the goal area" src={objective} />
