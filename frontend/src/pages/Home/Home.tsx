...
export function Home() {
  ...
  return (
    <ContentWrapper boxProps={{ height: '100%' }}>
      <h1>Play Outwit</h1>
      <p className="lead mt-3">Outwit is a fun two-player strategy game that was originally released in 1975.<br />I decided it would be a fun project to build a web version of the game. If you're interested in learning more about the game, <a href="https://boardgamegeek.com/boardgame/4696/outwit" target="_blank" rel="noreferer">this</a> is a good resource.</p>
