...
export function Home() {
  ...
  return (
    <ContentWrapper boxProps={{ height: '100%' }}>
      <h1>Play Nitwit</h1>
      <p className="lead mt-3">Nitwit is a fun two-player strategy game that is inspired by the game Outwit (1975).<br />I decided it would be a fun project to build an improved version of the original. If you're interested in learning more about the original game, <a href="https://boardgamegeek.com/boardgame/4696/outwit" target="_blank" rel="noreferer">this</a> is a good resource.</p>
